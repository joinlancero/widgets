const styles = `
    ...
    #lancero-widget #lancero-feedback {
        tab-size: 4;
        -webkit-text-size-adjust: 100%;
        font-family: inherit;
        -webkit-font-smoothing: antialiased;
    ...
    #lancero-widget .error {
        color: rgba(239,68,68,1);
    }

    #lancero-widget .success {
        color: rgba(34,197,94,1);
    }

    #lancero-widget #lancero-button {
        tab-size: 4;
        -webkit-text-size-adjust: 100%;
        -webkit-font-smoothing: antialiased;
        box-sizing: border-box;
...
const widget = document.getElementById('lancero-widget');
